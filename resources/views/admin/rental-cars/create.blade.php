...
@section('title', 'Admin | Tambah Mobil Rental')

@section('content')
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold">Tambah Mobil Rental</h1>
            <p class="mt-1 text-sm text-slate-600">Buat data mobil baru.</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.rental-cars.store') }}" enctype="multipart/form-data" class="mt-6">
        @csrf

        @include('admin.rental-cars._form')
